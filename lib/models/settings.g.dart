...
const SettingsSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'jrePath': PropertySchema(id: 83, name: r'jrePath', type: IsarType.string),
...
void _settingsSerialize(
  ...
  writer.writeLongList(offsets[59], object.downloadQueueOrder);
  ...
  writer.writeDouble(offsets[71], object.flexColorSchemeBlendLevel);
  writer.writeLong(offsets[72], object.flexSchemeColorIndex);
  writer.writeBool(offsets[73], object.followSystemTheme);
  writer.writeBool(offsets[74], object.forceLandscapePlayer);
  writer.writeBool(offsets[75], object.fullScreenPlayer);
  writer.writeBool(offsets[76], object.fullScreenReader);
  writer.writeBool(offsets[77], object.grayscale);
  writer.writeBool(offsets[78], object.hideDiscordRpcInIncognito);
  writer.writeStringList(offsets[79], object.hideItems);
  writer.writeString(offsets[80], object.hwdecMode);
  writer.writeBool(offsets[81], object.incognitoMode);
  writer.writeBool(offsets[82], object.invertColors);
  writer.writeString(offsets[83], object.jrePath);
  writer.writeBool(offsets[84], object.keepScreenOnReader);
  writer.writeString(offsets[85], object.lastTrackerLibraryLocation);
  writer.writeBool(offsets[86], object.libraryDownloadedChapters);
  writer.writeLong(offsets[87], object.libraryFilterAnimeBookMarkedType);
  writer.writeLong(offsets[88], object.libraryFilterAnimeCompletedType);
  writer.writeLong(offsets[89], object.libraryFilterAnimeDownloadType);
  writer.writeLong(offsets[90], object.libraryFilterAnimeStartedType);
  writer.writeLong(offsets[91], object.libraryFilterAnimeTrackingType);
  writer.writeLong(offsets[92], object.libraryFilterAnimeUnreadType);
  writer.writeLong(offsets[93], object.libraryFilterMangasBookMarkedType);
  writer.writeLong(offsets[94], object.libraryFilterMangasCompletedType);
  writer.writeLong(offsets[95], object.libraryFilterMangasDownloadType);
  writer.writeLong(offsets[96], object.libraryFilterMangasStartedType);
  writer.writeLong(offsets[97], object.libraryFilterMangasTrackingType);
  writer.writeLong(offsets[98], object.libraryFilterMangasUnreadType);
  writer.writeLong(offsets[99], object.libraryFilterNovelBookMarkedType);
  writer.writeLong(offsets[100], object.libraryFilterNovelCompletedType);
  writer.writeLong(offsets[101], object.libraryFilterNovelDownloadType);
  writer.writeLong(offsets[102], object.libraryFilterNovelStartedType);
  writer.writeLong(offsets[103], object.libraryFilterNovelTrackingType);
  writer.writeLong(offsets[104], object.libraryFilterNovelUnreadType);
  writer.writeBool(offsets[105], object.libraryLocalSource);
  writer.writeBool(offsets[106], object.libraryShowCategoryTabs);
  writer.writeBool(offsets[107], object.libraryShowContinueReadingButton);
  writer.writeBool(offsets[108], object.libraryShowLanguage);
  writer.writeBool(offsets[109], object.libraryShowNumbersOfItems);
  writer.writeStringList(offsets[110], object.localFolders);
  writer.writeObject<L10nLocale>(
    offsets[111],
    allOffsets,
    L10nLocaleSchema.serialize,
  ...
  writer.writeLong(offsets[113], object.mangaGridSize);
  writer.writeByte(offsets[114], object.mangaHomeDisplayType.index);
  writer.writeLong(offsets[115], object.markEpisodeAsSeenType);
  writer.writeBool(offsets[116], object.mergeLibraryNavMobile);
  writer.writeStringList(offsets[117], object.navigationOrder);
  writer.writeByte(offsets[118], object.novelDisplayType.index);
  writer.writeObjectList<Repo>(
    offsets[119],
    allOffsets,
    RepoSchema.serialize,
  ...
  writer.writeBool(offsets[156], object.showSourceBadge);
  ...
  writer.writeBool(offsets[167], object.tvAnimeOnlyOverride);
  writer.writeBool(offsets[168], object.tvForceDev);
  writer.writeBool(offsets[169], object.tvHomeGenreRows);
  writer.writeBool(offsets[170], object.tvHomeStyle);
  writer.writeBool(offsets[171], object.tvPlayerStyle);
  ...
  writer.writeBool(offsets[173], object.updateProgressAfterReading);
  writer.writeLong(offsets[174], object.updatedAt);
  writer.writeBool(offsets[175], object.useLibass);
  writer.writeBool(offsets[176], object.useMpvConfig);
  writer.writeBool(offsets[177], object.usePageTapZones);
  writer.writeBool(offsets[178], object.useYUV420P);
  writer.writeString(offsets[179], object.userAgent);
  writer.writeLong(offsets[180], object.volumeBoostCap);
  writer.writeLong(offsets[181], object.webtoonSidePadding);
}
...
Settings _settingsDeserialize(
  ...
  final object = Settings(
    ...
    downloadQueueOrder: reader.readLongList(offsets[59]),
    ...
    flexColorSchemeBlendLevel: reader.readDoubleOrNull(offsets[71]),
    flexSchemeColorIndex: reader.readLongOrNull(offsets[72]),
    followSystemTheme: reader.readBoolOrNull(offsets[73]),
    forceLandscapePlayer: reader.readBoolOrNull(offsets[74]),
    fullScreenPlayer: reader.readBoolOrNull(offsets[75]),
    fullScreenReader: reader.readBoolOrNull(offsets[76]),
    grayscale: reader.readBoolOrNull(offsets[77]),
    hideDiscordRpcInIncognito: reader.readBoolOrNull(offsets[78]),
    hideItems: reader.readStringList(offsets[79]),
    hwdecMode: reader.readStringOrNull(offsets[80]),
    id: id,
    incognitoMode: reader.readBoolOrNull(offsets[81]),
    invertColors: reader.readBoolOrNull(offsets[82]),
    jrePath: reader.readStringOrNull(offsets[83]),
    keepScreenOnReader: reader.readBoolOrNull(offsets[84]),
    lastTrackerLibraryLocation: reader.readStringOrNull(offsets[85]),
    libraryDownloadedChapters: reader.readBoolOrNull(offsets[86]),
    libraryFilterAnimeBookMarkedType: reader.readLongOrNull(offsets[87]),
    libraryFilterAnimeCompletedType: reader.readLongOrNull(offsets[88]),
    libraryFilterAnimeDownloadType: reader.readLongOrNull(offsets[89]),
    libraryFilterAnimeStartedType: reader.readLongOrNull(offsets[90]),
    libraryFilterAnimeTrackingType: reader.readLongOrNull(offsets[91]),
    libraryFilterAnimeUnreadType: reader.readLongOrNull(offsets[92]),
    libraryFilterMangasBookMarkedType: reader.readLongOrNull(offsets[93]),
    libraryFilterMangasCompletedType: reader.readLongOrNull(offsets[94]),
    libraryFilterMangasDownloadType: reader.readLongOrNull(offsets[95]),
    libraryFilterMangasStartedType: reader.readLongOrNull(offsets[96]),
    libraryFilterMangasTrackingType: reader.readLongOrNull(offsets[97]),
    libraryFilterMangasUnreadType: reader.readLongOrNull(offsets[98]),
    libraryFilterNovelBookMarkedType: reader.readLongOrNull(offsets[99]),
    libraryFilterNovelCompletedType: reader.readLongOrNull(offsets[100]),
    libraryFilterNovelDownloadType: reader.readLongOrNull(offsets[101]),
    libraryFilterNovelStartedType: reader.readLongOrNull(offsets[102]),
    libraryFilterNovelTrackingType: reader.readLongOrNull(offsets[103]),
    libraryFilterNovelUnreadType: reader.readLongOrNull(offsets[104]),
    libraryLocalSource: reader.readBoolOrNull(offsets[105]),
    libraryShowCategoryTabs: reader.readBoolOrNull(offsets[106]),
    libraryShowContinueReadingButton: reader.readBoolOrNull(offsets[107]),
    libraryShowLanguage: reader.readBoolOrNull(offsets[108]),
    libraryShowNumbersOfItems: reader.readBoolOrNull(offsets[109]),
    localFolders: reader.readStringList(offsets[110]),
    ...
    mangaGridSize: reader.readLongOrNull(offsets[113]),
    mangaHomeDisplayType:
        _SettingsmangaHomeDisplayTypeValueEnumMap[reader.readByteOrNull(
          offsets[114],
        )] ??
        DisplayType.comfortableGrid,
    markEpisodeAsSeenType: reader.readLongOrNull(offsets[115]),
    mergeLibraryNavMobile: reader.readBoolOrNull(offsets[116]),
    navigationOrder: reader.readStringList(offsets[117]),
    novelDisplayType:
    ...
    showSourceBadge: reader.readBoolOrNull(offsets[156]),
    ...
    tvAnimeOnlyOverride: reader.readBoolOrNull(offsets[167]),
    tvForceDev: reader.readBoolOrNull(offsets[168]),
    tvHomeGenreRows: reader.readBoolOrNull(offsets[169]),
    tvHomeStyle: reader.readBoolOrNull(offsets[170]),
    tvPlayerStyle: reader.readBoolOrNull(offsets[171]),
    ...
    updateProgressAfterReading: reader.readBoolOrNull(offsets[173]),
    updatedAt: reader.readLongOrNull(offsets[174]),
    useLibass: reader.readBoolOrNull(offsets[175]),
    useMpvConfig: reader.readBoolOrNull(offsets[176]),
    usePageTapZones: reader.readBoolOrNull(offsets[177]),
    useYUV420P: reader.readBoolOrNull(offsets[178]),
    userAgent: reader.readStringOrNull(offsets[179]),
    volumeBoostCap: reader.readLongOrNull(offsets[180]),
    webtoonSidePadding: reader.readLongOrNull(offsets[181]),
  );
...
extension SettingsQueryFilter
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> tvForceDevIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'tvForceDev'),
      );
    });
  }
  ...
  tvForceDevIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'tvForceDev'),
      );
    });
  }

  QueryBuilder<Settings, Settings, QAfterFilterCondition> tvForceDevEqualTo(
    bool? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'tvForceDev', value: value),
      );
    });
  }
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByTvForceDev() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tvForceDev', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByTvForceDevDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tvForceDev', Sort.desc);
    });
  }
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByTvForceDev() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tvForceDev', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByTvForceDevDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tvForceDev', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByTvForceDev() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'tvForceDev');
    });
  }
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, bool?, QQueryOperations> tvForceDevProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'tvForceDev');
    });
  }
