...
class _BrowseScreenState extends ConsumerState<BrowseScreen>
  ...
  /// asked and when the tab they asked for is not in this list. Null hands
  /// the decision back to the remembered section rather than silently
  /// answering the first tab.
  ///
